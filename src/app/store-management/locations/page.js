    ...
    <div className="bg-white rounded-lg shadow-sm border border-[#D3D3D3]/80 flex flex-col overflow-hidden min-h-[420px]">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-[#363636]/70 mt-0.5 font-normal">
              จัดการตำแหน่งจัดเก็บ ชั้นวาง และโซนจัดเก็บสินค้าภายในร้านค้า
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-12 text-center">
        <div className="w-14 h-14 rounded-full bg-stone-100 flex items-center justify-center text-stone-400 mb-3">
          <RiArchiveDrawerLine className="w-7 h-7" />
        </div>
        <p className="text-sm font-medium text-[#2B2F38]">หน้าตำแหน่งจัดเก็บสินค้า</p>
        <p className="text-xs text-stone-500 mt-1 max-w-sm">
          หน้านี้ถูกสร้างขึ้นเพื่อเตรียมพร้อมสำหรับการจัดการชั้นวางและตำแหน่งจัดเก็บสินค้าในคลัง
        </p>
      </div>
    </div>
  );
